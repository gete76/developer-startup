...
CREATE INDEX index_image_votes_on_user_id ON image_votes (user_id);
CREATE INDEX index_image_votes_on_image_id ON image_votes (image_id);
...
CREATE INDEX index_images_observations_on_observation_id ON images_observations (observation_id, image_id);
...
CREATE INDEX index_observation_images_on_observation_id_image_id on observation_images (observation_id, image_id);
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
